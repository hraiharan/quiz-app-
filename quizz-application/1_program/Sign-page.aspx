<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sign-page.aspx.cs" Inherits="quizz_application.Sign_page" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <table align="left" aria-orientation="horizontal" cellpadding="5" class="auto-style1">
                ...
                <tr>
                    <td>
                        <asp:HyperLink ID="HyperLink2" class="btn btn-primary" runat="server" NavigateUrl="~/Main-page.aspx" Height="34px" Width="94px">Back</asp:HyperLink>
                    </td>
                    <td>&nbsp;</td>
                    <td>
