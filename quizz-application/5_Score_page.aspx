<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="5_Score_page.aspx.cs" Inherits="quizz_application.Score" %>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="5_Score_page.aspx">Score<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="3_Quizz-selection.aspx">Home</a>
      </li>
      <li class="nav-item">
        &nbsp;</li>
    </ul> 
